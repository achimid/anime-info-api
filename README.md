...
# [Anime Info API](https://anime-info-api.achimid.com.br/)

- https://anime-info-api.achimid.com.br
...
Serviço para export informações de animes originadas de diversas fontes em uma API REST web.

## Endpoints

```
GET     /api/v1/search?q=Isekai
GET     /api/v1/search/list/names
